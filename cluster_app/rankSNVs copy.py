...
parser.add_argument("-pval","--pval_thresh", type = float, default = .0001, help = "optional highest threshold for pvalue")
...
with open(filename, "r") as inputfile: 
	...
	for line in inputfile: 
		referenceline = line.split() 
		referencename = referenceline[0]
		break
...
outputfile.write(str(len(sortedtuples)) + "\t" + "of ranked snps with referece " + referencename +"\n")
