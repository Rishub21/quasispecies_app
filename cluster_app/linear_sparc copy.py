...
def mediary(tuple): 
	...
	fullrecursionpipeline(new_Input, reference, ranking, startingindex, endingindex, percentagethresh, pvalthresh, read2thresh, snpthresh, True)
...
if __name__ == "__main__":
	...
	consensus_dict = defaultdict(str)
  	#pool = gevent.pool.Pool(int(nproc))  
        fullrecursionpipeline(filename, reference, ranking, startingindex, endingindex, percentagethresh, pvalthresh, read2thresh, snpthresh, False)
	#pool.join() 
